...
$file_query = "SELECT * FROM 201_files WHERE folder_id = $folder_id ORDER BY uploaded_at DESC";
                                ...
                                <tbody>
                                        ...
                                        while ($subfolder = mysqli_fetch_assoc($subfolder_result)) {
                                            ...
                                            echo '<tr>
                                                ...
                                                <td class="file-actions text-right" style="text-align: center;">
                                                    ...
                                                    <a href="201-files.php?folder_id=' . $folderId . '" class="btn btn-info" style="width: 41%; margin-right: 5px;" title="Open Folder">
                                                        <i class="fa fa-folder-open"></i> Open
                                                    </a>
                                                    <a href="actions/201-delete-subfolder.php?id=' . $folderId . '" class="btn btn-danger delete-btn" title="Delete">
                                    ...
                                    if (mysqli_num_rows($file_result) > 0) {
                                        while ($file = mysqli_fetch_assoc($file_result)) {
                                            ...
                                            if ($isPdf) {
                                                echo '<button class="btn btn-primary preview-btn" data-file="actions/201-view-files.php?id=' . $fileId . '" title="Preview">
