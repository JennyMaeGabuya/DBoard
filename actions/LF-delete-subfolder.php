...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    function deleteFolderAndContents($folder_id, $con)
    {
        ...
        $subfolders_result = mysqli_query($con, "SELECT id FROM leave_folders WHERE parent_id = $folder_id");
        ...
        $file_result = mysqli_query($con, "SELECT filename FROM leave_files WHERE folder_id = $folder_id");
        ...
        mysqli_query($con, "DELETE FROM leave_files WHERE folder_id = $folder_id");
        ...
        mysqli_query($con, "DELETE FROM leave_folders WHERE id = $folder_id");
    }
    ...
    // Redirect back
    $referer = $_SERVER['HTTP_REFERER'] ?? 'LF-files.php';
