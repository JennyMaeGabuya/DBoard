...
$checkQuery = "SELECT COUNT(*) as count FROM leave_folders WHERE name = '$folder_name' AND id != $folder_id";
...
$currentFolderQuery = "SELECT name, parent_id FROM leave_folders WHERE id = $folder_id";
...
$query = "UPDATE leave_folders SET name = '$folder_name' WHERE id = $folder_id";
