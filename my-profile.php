            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="breadcome-menu">
                  ...
                  <li><span class="bread-blod">My Profile</span></li>
                </ul>
              </div>
            </div>
          </div>
                        ...
                        <div id="dropzone1" class="pro-ad">
                          ...
                          <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div class="form-group">
                                <input name="laststname" type="text" class="form-control" placeholder="Lastname" />
                              </div>
                              <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div class="form-group">
                                <input name="website" type="text" class="form-control" placeholder="Blood Type" />
                              </div>
                              <div class="form-group">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="payment-adress">
                                <button href="edit-info.php" class="btn btn-primary waves-effect waves-light">
                                  Edit
                                </button>
                                <a type="back" href="dashboard.php" class="btn btn-warning waves-effect waves-light">
                                  Back
                                </a>
                            ...
                            <div class="devit-card-custom">
                              ...
                              <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                  ...
                                  <div class="form-group">
                                    <input name="middlename" type="text" class="form-control" placeholder="Salary" />
                                  </div>
                                  <div class="form-group">
                                    <input name="middlename" type="text" class="form-control"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                  ...
                                  <div class="form-group">
                                    <input name="laststname" type="text" class="form-control"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                  ...
                                  <div class="form-group">
                                    <input name="middlename" type="text" class="form-control" placeholder="Status" />
                                  </div>
                                  <div class="form-group">
                                    <input name="middlename" type="text" class="form-control" placeholder="branch" />
                                  </div>
                                  <div class="form-group">
                                    <input name="middlename" type="text" class="form-control"
