            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="breadcome-menu">
                  ...
                  <li><span class="bread-blod">Analytics</span></li>
                </ul>
              </div>
            </div>
          </div>
  ...
  <div class="income-order-visit-user-area">
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="income-dashone-total reso-mg-b-30">
            <div class="income-dashone-pro">
              ...
              <div class="income-range">
                <p>Total Income</p>
                <span class="income-percentange bg-green"><span class="counter">95</span>%
          ...
          <div class="income-dashone-total">
            <div class="income-dashone-pro">
              ...
              <div class="income-range order-cl">
                <p>New Adminsion</p>
                <span class="income-percentange bg-red"><span class="counter">65</span>%
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div
            class="income-dashone-total res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
            <div class="income-dashone-pro">
              <div class="income-rate-total">
                <div class="price-edu-rate">
              ...
              <div class="income-range visitor-cl">
                <p>New Visitor</p>
                <span class="income-percentange bg-blue"><span class="counter">75</span>%
                  <i class="fa fa-level-up"></i>
                </span>
              </div>
              <div class="clear"></div>
  ...
  <div class="dashtwo-order-area mg-tb-30">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div
            class="analytics-edu-wrap reso-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div
            class="analytics-edu-wrap res-tablet-mg-t-30 dk-res-t-pro-30">
  ...
  <div class="analytics-sparkle-area">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div
            class="analytics-sparkle-line reso-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
            <div class="analytics-content">
              <h5>Last month</h5>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div
            class="analytics-sparkle-line res-tablet-mg-t-30 dk-res-t-pro-30">
            <div class="analytics-content">
              <h5>Avarage time</h5>
              <h2>00:06:40</h2>
  ...
  <div class="analysis-rounded-area mg-tb-30">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div class="analytics-rounded reso-mg-b-30">
            <div class="analytics-rounded-content">
              ...
              <h2>
                <span class="counter">140</span>/<span class="counter">54</span>
              </h2>
              <div class="text-center">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div
            class="analytics-rounded reso-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
            <div class="analytics-rounded-content">
