  ...
  <div class="left-sidebar-pro">
    <nav id="sidebar" class="">
      <div class="sidebar-header">
        ...
        <strong><a href="index.php"><img src="img/logo/sidebar-logo.png" alt="" style="width: 60px; height: auto;" /></a></strong>
      </div>
          ...
          <ul class="metismenu" id="menu1">
            ...
            <li>
              ...
              <ul class="submenu-angle" aria-expanded="false">
                ...
                <li>
                  <a title="Edit Courses" href="edit-course.php"><span class="mini-sub-pro">Edit Course</span></a>
                </li>
                <li>
                  <a title="Courses Profile" href="course-info.php"><span class="mini-sub-pro">Courses Info</span></a>
                </li>
                <li>
