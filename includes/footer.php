<audio id="event-alert-sound">
    <source src="../sounds/gwenchana.mp3" type="audio/mpeg">
</audio>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.addEventListener("click", () => document.getElementById("event-alert-sound").play());
        document.addEventListener("keydown", () => document.getElementById("event-alert-sound").play());
    });
