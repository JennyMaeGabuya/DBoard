                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                      <ul class="breadcome-menu">
                        ...
                        <li><span class="bread-blod">Dashboard V.1</span></li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
              <div class="product-sales-chart">
                ...
                <ul class="list-inline cus-product-sl-rp">
                  ...
                  <li>
                    <h5>
                      <i class="fa fa-circle" style="color: #933ec5"></i
                      >Accounting
                    </h5>
                  </li>
                  <li>
                ...
                <ul class="list-inline two-part-sp">
                  ...
                  <li class="text-right sp-cn-r">
                    ...
                    <span class="counter text-success"
                      ><span class="counter">1500</span></span
                    >
                  </li>
                </ul>
              </div>
                ...
                <ul class="list-inline two-part-sp">
                  ...
                  <li class="text-right graph-two-ctn">
                    ...
                    <span class="counter text-purple"
                      ><span class="counter">3000</span></span
                    >
                  </li>
                </ul>
              </div>
                ...
                <ul class="list-inline two-part-sp">
                  ...
                  <li class="text-right graph-three-ctn">
                    ...
                    <span class="counter text-info"
                      ><span class="counter">5000</span></span
                    >
                  </li>
                </ul>
              </div>
              <div
                class="white-box analytics-info-cs tb-sm-res-d-n dk-res-t-d-n"
              >
      ...
      <div class="product-sales-area mg-tb-30">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div
                class="analysis-progrebar res-mg-t-30 mg-ub-10 table-mg-t-pro-n res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n"
              >
              ...
              <div
                class="analysis-progrebar reso-mg-b-30 mg-ub-10 res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n"
              >
                <div class="analysis-progrebar-content">
                  <h5>Memory</h5>
                  <h2 class="storage-right">
              ...
              <div
                class="analysis-progrebar reso-mg-b-30 res-mg-t-30 mg-ub-10 res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n"
              >
                <div class="analysis-progrebar-content">
                  <h5>Data</h5>
                  <h2 class="storage-right">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
              <div class="white-box">
                ...
                <ul class="basic-list">
                  ...
                  <li>
                    Mozila Firefox
                    <span class="pull-right label-purple label-6 label"
                      >26.8%</span
                    >
                  </li>
                  <li>
                    Safari
                    <span class="pull-right label-purple label-7 label"
                      >31.8%</span
                    >
                  </li>
                </ul>
