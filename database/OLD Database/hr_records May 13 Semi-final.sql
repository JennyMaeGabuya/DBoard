...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2025 at 09:59 AM
...
CREATE TABLE `appointed_cert_issuance` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `extra_salary` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('PDC004', 'JOCELYN', 'RECIO', 'VERGARA', '', '1978-12-11', 'MATAASNAKAHOY, BATANGAS', 'Female', 'Single', 'NANGKAAN, MATAASNAKAHOY, BATANGAS', 'B+', 9007770383, 'jocelynvergara584@gmail.com', NULL, 'Office of the Municipal Planning and Development Coordinator', 'Administrative Assistant I (Bookbinder III)', 1, 0, '2025-05-09 23:10:28', '2025-05-13 07:00:40'),
...
(59, 'PDC004', '2002005049', '1490-002212-8412', '09-025009697-5', 'N/A', '185-399-690', '2025-05-09 23:10:28', '2025-05-09 23:10:28'),
...
(9, 'ACT005', '2021-01-04', '2025-05-04', 'Office of the Municipal General Services', 'Permanent', 23000.00, 'GSO', 'M-kahoy, Bats', 'four', '2025-05-05', '', '2025-05-10 16:00:00', '2025-05-10 16:00:00'),
