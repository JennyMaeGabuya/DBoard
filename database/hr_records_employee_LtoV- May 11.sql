...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2025 at 05:40 AM
...
(1, 'HRM-ADMIN', 'admin', '$2y$10$wqvEaTtRI0nEDhPjE9c6yujXvGzJ/ySeu5/ULFfYSiO1MMjYbY1sS', 'jennymaegabuya8@gmail.com', 'superadmin', '2025-02-16 22:35:11', '2025-05-02 18:32:39', '70d595eb8df0e895ef9a01aef3bd56fc307658eb4f7911da752a8da2f4b37d33dac6d38421fba0a9b175e99b106d92d68391', '2025-03-30 11:55:31');
...
CREATE TABLE `appointed_cert_issuance` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `extra_salary` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`extra_salary`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('HRM-ADMIN', 'GALLY', 'DIMAYUGA', 'TIPAN', '', '1990-06-28', 'CUENCA, BATANGAS', 'Male', 'Single', 'CUENCA, BATANGAS', 'A+', 9175633720, 'admin@gmail.com', 'Gally.png', 'Office of the Municipal Human Resource Management', 'Municipal Government Department Head (Municipal Human Resource Management Officer)', 1, 1, '2025-02-16 22:33:54', '2025-05-09 08:00:00'),
...
('HRM005', 'ELMIE', 'HERNANDEZ', 'PANAGANIBAN', '', '1976-12-02', 'MATAASNAKAHOY, BATANGAS', 'Female', 'Married', 'PUROK 3, BUBUYAN, MATAASNAKAHOY, BATANGAS', 'O+', 9293470507, 'elmiehp@gmail.com', NULL, 'Office of the Municipal Human Resource Management', 'Administrative Aide VI (Clerk III)', 1, 1, '2025-05-09 11:46:56', '2025-05-09 11:46:56'),
...
(2, 'HRM-ADMIN', '2004647207', '1211-3530-8011', '09-000092019-2', 'N/A', '463-485-211', '2025-03-11 00:25:50', '2025-05-09 08:00:00'),
...
(36, 'HRM005', '2005832266', '1030-0024-9608', '092023951896', '04-3173606-06', '206-869-629', '2025-05-09 11:46:56', '2025-05-09 11:46:56'),
...
(10, 'HRM-ADMIN', '2019-02-02', '2025-05-04', 'Office of the Municipal Human Resource', 'Permanent', '80000.00', 'HR', 'M-kahoy, Bats', 'two', '2025-05-04', '', '2025-05-10 16:00:00', '2025-05-10 16:00:00');
...
--
-- Indexes for table `leave_folders`
--
ALTER TABLE `leave_folders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parent_id` (`parent_id`);
...
--
-- AUTO_INCREMENT for table `leave_folders`
--
ALTER TABLE `leave_folders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
